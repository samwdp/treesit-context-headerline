    ...
    (let ((icon-map (cond
                     ((eq backend 'nerd-icons)
                      ...
                      '(("function" . ("codicon" . "symbol-function"))
                        ("function_definition" . ("codicon" . "symbol-function"))
                        ("function_declaration" . ("codicon" . "symbol-function"))
                        ("method" . ("codicon" . "symbol-function"))
                        ("method_definition" . ("codicon" . "symbol-function"))
                        ("method_declaration" . ("codicon" . "symbol-function"))
